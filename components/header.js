        ...
        <div>
            ...
            {isOpen && (
                <div className="md:hidden   h-[calc(100vh_-_6rem)] px-6 flex flex-col z-1000">
                    <div className="hidden flex h-16 items-center  ">
                    ...
                    <div className="w-full mt-2 py-4  text-xs font-bold hover:cursor-pointer   hover:text-red-700 ">
                        <Link href="/">ACCEUIL</Link>
                    </div>
                    <div className="w-full mt-2 py-4   text-xs font-bold hover:cursor-pointer   hover:text-red-700 ">
                        ENTREPRISE
                    ...
                    <div
                        className={
                            'relative  text-xs font-bold flex flex-col   '
                        }
                    >
                        <div
                            className="w-full mt-2 py-4 flex  text-xs font-bold hover:cursor-pointer   hover:text-red-700 "
                            onClick={() => setClicked(!clicked)}
                        >
                            <p>NOS PRODUITS</p>
                            <RiArrowDropDownLine className="text-xl " />
                            ...
                            <AnimatePresence>
                                {clicked && (
                                    <motion.div
                                        ...
                                        animate={{ y: 0, opacity: 1 }}
                                        exit={{ opacity: 0 }}
                                        className=" bg-beige flex  uppercase text-gray top-[100%]  left-0 w-full px-4 py-6  "
                                    >
                                        <ul>
                                            <Link href="/categories">
                                                <p className="hover:text-red-700">
